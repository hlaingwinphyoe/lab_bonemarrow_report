...
Route::get('/trephine',[IndexController::class,'trephine'])->name('trephine');
Route::get('/histo',[IndexController::class,'histo'])->name('histo');
Route::get('/cyto',[IndexController::class,'cyto'])->name('cyto');
