                                ...
                                <div class="row">
                                    <div class="col-6 col-xl-2">
                                        <div class="d-flex">
                                            ...
                                            @endcan
                                            @if($cytos->count() > 0)
                                                <a href="{{ route('cyto.export') }}" class="btn btn-success mb-3" style="width: 125px"><img src="{{ asset('images/excel.png') }}" width="15" alt=""> Export</a>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <table class="table table-hover  mb-3">
                        ...
                        @forelse($cytos as $cyto)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-light btn-sm" href="{{ route('cyto.without.print',$cyto->id) }}">
