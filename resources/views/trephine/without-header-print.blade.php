...
<head>
    ...
    <link rel="icon" href="{{ asset('images/png.jpg') }}">
    <style>
        .print-table tr {
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="position-relative">
                            <a href="{{ route('trephine.index') }}" class="btn btn-primary back-btn"><i
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <div class="ms-3 mt-2">
                                    <div class="row mb-2">
                                        <div class="text-end">
                                            <button class="btn btn-primary" onclick="return print()"><i
                                            ...
                                            <div class="print-header my-1">
                                                ...
                                                <span>
                                                    @forelse($patientFact->trephinePhotos as $key=>$photo)
                                                        <img src="{{ asset('storage/trephine_thumbnails/' . $photo->name) }}"
                                                            class="rounded shadow-sm" height="100" alt="image alt" />
                                                    @empty
                                                    @endforelse
                                                </span>
                                            </div>
                                    ...
                                    <table class="table table-borderless print-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="fw-bold text-capitalize title text-nowrap">Name of
                                                    institution</td>
                                                <td class="result">{{ $patientFact->hospital->name }}</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Laboratory Accession Number
                                                </td>
                                            ...
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Significant clinical history
                                                </td>
                                                <td class="result">{{ $patientFact->clinical_history ?? '-' }}</td>
                                            </tr>

                                            <tr>
                                                <td class="fw-bold text-capitalize title">Indication for bone marrow
                                                    examination</td>
                                                <td class="result">{{ $patientFact->bmexamination ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Anatomic site of
                                                    aspirate/biopsy</td>
                                                <td class="result">{{ $patientFact->anatomic_site_trephine ?? '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Ease/difficulty of aspiration
                                                </td>
                                            ...
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Blood smear description and
                                                    diagnostic conclusion</td>
                                                <td class="result">{{ $patientFact->percentage_cellularity ?? '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Cellularity of particles and
                                                    cell trails</td>
                                                <td class="result">{{ $patientFact->bone_architecture ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Nucleated differential cell
                                                    count</td>
                                                <td class="result">{{ $patientFact->path ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-capitalize title">Total number of cells counted
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="result">{{ $patientFact->immunohistochemistry ?? '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                @if (isset($patientFact->user->signature))
                                                    <td class="result"><img
                                                            src="{{ asset('storage/signature_thumbnails/' . $patientFact->user->signature) }}"
                                                            style="width: 50px;height: 30px" alt=""></td>
                                                @else
